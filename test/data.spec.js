...
import { filtrarDoble,filtrarDobleLocaciones,obtenerDataTipo,ordenarAZ,filtering,ordenarPersonajes } from '../src/data.js';
...
describe('ordenar', () => {
  ...
  it('retorna la data ordenada A-Z', () => {
    // dado de la A la Z
    const mockOrder= "A-Z"
    // cuando
  ...
  it('retorna la data ordenada Z-A', () => {
    // dado de la A la Z
    const mockOrder= "Z-A"
    // cuando
    const sort =ordenarAZ(mockData,mockOrder)
...
describe('filtering', () => {
  ...
  it('retorna la data filtrada', () => {
    // console.log("retorna",filtering(mockData,"director","Hayao Miyazaki"))
